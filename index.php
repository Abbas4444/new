...
<head>
	...
	<meta name="description" content="Travel Diaries">
  ...
  <!-- Navbar -->
  	...
  	<div class="jumbotron">
  		<div class="container text-center">
  			...
  			<p>Travel Stories from explored Corners</p>
  			...
  			<div class="carousel slide" id="screenshot-carousel" data-ride="carousel">
  				...
  				<div class="carousel-inner">
  					<div class="item active">
  						<img src="london.jpg" alt="Text of the image">
  					...
  					<div class="item">
  						<img src="london1.jpg" alt="Text of the image">
  						<div class="carousel-caption">
  							<h3>London Eye</h3>
  							<p>This is the caption</p>
  						</div>
  					...
  					<div class="item">
  						<img src="london2.jpg" alt="Text of the image">
  						<div class="carousel-caption">
  					...
  					<div class="item">
  						<img src="london3.jpg" alt="Text of the image">
  						<div class="carousel-caption">
    ...
    <footer>
      <hr>
        ...
        <ul class="list-inline">
          <li><a href="https://twitter.com/coolestdude_444">Twitter</a></li>
          <li><a href="https://www.facebook.com/abbas.lakdawala.1">Facebook</a></li>
        </ul>
